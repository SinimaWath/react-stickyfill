...
var _stickyfilljsFork = require("stickyfilljs-fork");

var _stickyfilljsFork2 = _interopRequireDefault(_stickyfilljsFork);
...
var Sticker = function (_Component) {
	...
	_createClass(Sticker, [{
		...
		value: function sticky(stick) {
			_stickyfilljsFork2.default.add(stick);
			this.setState({
				isSticky: true
			});
		}
		...
		value: function unsticky(stick) {
			_stickyfilljsFork2.default.remove(stick);
			this.setState({
				isSticky: false
			});
		}
		...
		value: function componentDidMount() {
			...
			if (scrollContainer) {
				...
				_stickyfilljsFork2.default.setTopOffset(offset);
				_stickyfilljsFork2.default.setScrollContainer(scrollContainer);
			}

			if (forcePolyfill) {
				_stickyfilljsFork2.default.forceSticky();
			}
